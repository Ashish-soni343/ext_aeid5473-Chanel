...
class ChanelMexicoSpider(scrapy.Spider):    # Starting our spider with a class which contains url to initiate crawling
    name = 'chanel_mexico'
    site = 'https://www.chanel.com'

    start_urls = ['https://www.chanel.com/mx/']
    frag_url = 'https://www.chanel.com/mx/perfumes/femeninos/c/7x1x1/page-'
    frag_m_url = 'https://www.chanel.com/mx/perfumes/masculinos/c/7x1x2/page-'
    eyegls_url = 'https://www.chanel.com/mx/gafas/gafas-para-graduar/c/2x1x2/page-'
    sungls_url = 'https://www.chanel.com/mx/gafas/gafas-de-sol/c/2x1x1/page-'
    watch_url = 'https://www.chanel.com/mx/relojes/coleccion/c/4x2/page-'
    fine_jewellery = 'https://www.chanel.com/mx/joyeria/coleccion/c/3x2/page-'
    face_url = 'https://www.chanel.com/mx/maquillaje/tez/c/5x1x6/page-'
    eye_url = 'https://www.chanel.com/mx/maquillaje/ojos/c/5x1x4/page-'
    lips_url = 'https://www.chanel.com/mx/maquillaje/labios/c/5x1x1/page-'
    nails_url = 'https://www.chanel.com/mx/maquillaje/unas/c/5x1x7/page-'
    brushes_url = 'https://www.chanel.com/mx/maquillaje/pinceles-y-accesorios/c/5x1x3/page-'
    skin_care = 'https://www.chanel.com/mx/tratamiento/categoria/c/6x1/page-'
    skin_line_url = 'https://www.chanel.com/mx/tratamiento/coleccion/c/6x2/page-'
    frag_bb_url = 'https://www.chanel.com/mx/perfumes/bano-y-cuerpo/c/7x1x7/page-'
    ...
    def parse(self, response):  # Getting the links from selector and filtering the required urls
        for link in response.css('ul.header__category__links a::attr(href)'):
            a = link.get()
            if a == '/mx/gafas/gafas-de-sol/c/2x1x1/':
                page = self.site + '/mx/gafas/gafas-de-sol/c/2x1x1/'
                next_page = response.follow(url=page, callback=self.sunglass)
                yield next_page

            elif a == '/mx/gafas/gafas-para-graduar/c/2x1x2/':
                page1 = self.site + '/mx/gafas/gafas-para-graduar/c/2x1x2/'
                next_page1 = response.follow(url=page1, callback=self.eyeglass)
                yield next_page1

            elif a == '/mx/perfumes/femeninos/c/7x1x1/':
                page2 = self.site + '/mx/perfumes/femeninos/c/7x1x1/'
                yield response.follow(url=page2, callback=self.fragrance)

            elif a == '/mx/relojes/coleccion/c/4x2/':
                page3 = self.site + '/mx/relojes/coleccion/c/4x2/'
                yield response.follow(url=page3, callback=self.watches)

            elif a == '/mx/joyeria/coleccion/c/3x2/':
                page4 = self.site + '/mx/joyeria/coleccion/c/3x2/'
                yield response.follow(url=page4, callback=self.fine_jwlry)

            elif a == '/mx/maquillaje/tez/c/5x1x6/':
                page5 = self.site + '/mx/maquillaje/tez/c/5x1x6/'
                yield response.follow(url=page5, callback=self.mkp_face)

            elif a == '/mx/maquillaje/ojos/c/5x1x4/':
                page6 = self.site + '/mx/maquillaje/ojos/c/5x1x4/'
                yield response.follow(url=page6, callback=self.mkp_eye)

            elif a == '/mx/maquillaje/labios/c/5x1x1/':
                page7 = self.site + '/mx/maquillaje/labios/c/5x1x1/'
                yield response.follow(url=page7, callback=self.mkp_lips)

            elif a == '/mx/maquillaje/unas/c/5x1x7/':
                page8 = self.site + '/mx/maquillaje/unas/c/5x1x7/'
                yield response.follow(url=page8, callback=self.mkp_nails)

            elif a == '/mx/maquillaje/pinceles-y-accesorios/c/5x1x3/':
                page9 = self.site + '/mx/maquillaje/pinceles-y-accesorios/c/5x1x3/'
                yield response.follow(url=page9, callback=self.mkp_brushes)

            elif a == '/mx/moda/pret-a-porter/':
                page10 = self.site + '/mx/moda/pret-a-porter/'
                yield response.follow(page10, callback=self.parse_page)

            elif a == '/mx/tratamiento/categoria/c/6x1/':
                page11 = self.site + '/mx/tratamiento/categoria/c/6x1/'
                yield response.follow(page11, callback=self.skin)

            elif a == '/mx/tratamiento/coleccion/c/6x2/':
                page12 = self.site + '/mx/tratamiento/coleccion/c/6x2/'
                yield response.follow(page12, callback=self.skin_line)

            elif a == '/mx/perfumes/masculinos/c/7x1x2/':
                page13 = self.site + '/mx/perfumes/masculinos/c/7x1x2/'
                yield response.follow(url=page13, callback=self.frag_m)

            elif a == '/mx/perfumes/bano-y-cuerpo/c/7x1x7/':
                page14 = self.site + '/mx/perfumes/bano-y-cuerpo/c/7x1x7/'
