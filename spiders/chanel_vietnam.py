...
class ChanelVietnamSpider(scrapy.Spider):    # Starting our spider with a class which contains url to initiate crawling
    name = 'chanel_vietnam'
    site = 'https://www.chanel.com'

    start_urls = ['https://www.chanel.com/vn']
    frag_url = 'https://www.chanel.com/vn/nuoc-hoa/nu-gioi/c/7x1x1/page-'
    frag_m_url = 'https://www.chanel.com/vn/nuoc-hoa/nam-gioi/c/7x1x2/page-'
    eyegls_url = 'https://www.chanel.com/vn/mat-kinh/mat-kinh/c/2x1x2/page-'
    sungls_url = 'https://www.chanel.com/vn/mat-kinh/kinh-mat/c/2x1x1/page-'
    watch_url = 'https://www.chanel.com/vn/dong-ho/bo-suu-tap/c/4x2/page-'
    fine_jewellery = 'https://www.chanel.com/vn/trang-suc/bo-suu-tap/c/3x2/page-'
    face_url = 'https://www.chanel.com/vn/trang-diem/da/c/5x1x6/page-'
    eye_url = 'https://www.chanel.com/vn/trang-diem/mat/c/5x1x4/page-'
    lips_url = 'https://www.chanel.com/vn/trang-diem/moi/c/5x1x1/page-'
    nails_url = 'https://www.chanel.com/vn/trang-diem/mong/c/5x1x7/page-'
    brushes_url = 'https://www.chanel.com/vn/trang-diem/co-va-phu-kien/c/5x1x3/page-'
    skin_care = 'https://www.chanel.com/vn/cham-soc-da/danh-muc/c/6x1/page-'
    skin_line_url = 'https://www.chanel.com/vn/cham-soc-da/bo-suu-tap/c/6x2/page-'
    frag_bb_url = 'https://www.chanel.com/vn/nuoc-hoa/san-pham-phong-tam-cham-soc-co-the/c/7x1x7/page-'
    ...
    def parse(self, response):  # Getting the links from selector and filtering the required urls
        for link in response.css('ul.header__category__links a::attr(href)'):
            a = link.get()
            if a == '/vn/mat-kinh/kinh-mat/c/2x1x1/':
                page = self.site + '/vn/mat-kinh/kinh-mat/c/2x1x1/'
                next_page = response.follow(url=page, callback=self.sunglass)
                yield next_page

            elif a == '/vn/mat-kinh/mat-kinh/c/2x1x2/':
                page1 = self.site + '/vn/mat-kinh/mat-kinh/c/2x1x2/'
                next_page1 = response.follow(url=page1, callback=self.eyeglass)
                yield next_page1

            elif a == '/vn/nuoc-hoa/nu-gioi/c/7x1x1/':
                page2 = self.site + '/vn/nuoc-hoa/nu-gioi/c/7x1x1/'
                yield response.follow(url=page2, callback=self.fragrance)

            elif a == '/vn/dong-ho/bo-suu-tap/c/4x2/':
                page3 = self.site + '/vn/dong-ho/bo-suu-tap/c/4x2/'
                yield response.follow(url=page3, callback=self.watches)

            elif a == '/vn/trang-suc/bo-suu-tap/c/3x2/':
                page4 = self.site + '/vn/trang-suc/bo-suu-tap/c/3x2/'
                yield response.follow(url=page4, callback=self.fine_jwlry)

            elif a == '/vn/trang-diem/da/c/5x1x6/':
                page5 = self.site + '/vn/trang-diem/da/c/5x1x6/'
                yield response.follow(url=page5, callback=self.mkp_face)

            elif a == '/vn/trang-diem/mat/c/5x1x4/':
                page6 = self.site + '/vn/trang-diem/mat/c/5x1x4/'
                yield response.follow(url=page6, callback=self.mkp_eye)

            elif a == '/vn/trang-diem/moi/c/5x1x1/':
                page7 = self.site + '/vn/trang-diem/moi/c/5x1x1/'
                yield response.follow(url=page7, callback=self.mkp_lips)

            elif a == '/vn/trang-diem/mong/c/5x1x7/':
                page8 = self.site + '/vn/trang-diem/mong/c/5x1x7/'
                yield response.follow(url=page8, callback=self.mkp_nails)

            elif a == '/vn/trang-diem/co-va-phu-kien/c/5x1x3/':
                page9 = self.site + '/vn/trang-diem/co-va-phu-kien/c/5x1x3/'
                yield response.follow(url=page9, callback=self.mkp_brushes)

            elif a == '/vn/thoi-trang/ready-to-wear/':
                page10 = self.site + '/vn/thoi-trang/ready-to-wear/'
                yield response.follow(page10, callback=self.parse_page)

            elif a == '/vn/cham-soc-da/danh-muc/c/6x1/':
                page11 = self.site + '/vn/cham-soc-da/danh-muc/c/6x1/'
                yield response.follow(page11, callback=self.skin)

            elif a == '/vn/cham-soc-da/bo-suu-tap/c/6x2/':
                page12 = self.site + '/vn/cham-soc-da/bo-suu-tap/c/6x2/'
                yield response.follow(page12, callback=self.skin_line)

            elif a == '/vn/nuoc-hoa/nam-gioi/c/7x1x2/':
                page13 = self.site + '/vn/nuoc-hoa/nam-gioi/c/7x1x2/'
                yield response.follow(url=page13, callback=self.frag_m)

            elif a == '/vn/nuoc-hoa/san-pham-phong-tam-cham-soc-co-the/c/7x1x7/':
                page14 = self.site + '/vn/nuoc-hoa/san-pham-phong-tam-cham-soc-co-the/c/7x1x7/'
