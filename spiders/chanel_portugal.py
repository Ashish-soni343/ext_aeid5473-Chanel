...
class ChanelPortugalSpider(scrapy.Spider):    # Starting our spider with a class which contains url to initiate crawling
    name = 'chanel_portugal'
    site = 'https://www.chanel.com'

    start_urls = ['https://www.chanel.com/pt/']
    frag_url = 'https://www.chanel.com/pt/perfumes/mulheres/c/7x1x1/page-'
    frag_m_url = 'https://www.chanel.com/pt/perfumes/homens/c/7x1x2/page-'
    eyegls_url = 'https://www.chanel.com/pt/oculos/oculos-graduados/c/2x1x2/page-'
    sungls_url = 'https://www.chanel.com/pt/oculos/oculos-de-sol/c/2x1x1/page-'
    watch_url = 'https://www.chanel.com/pt/relogios/colecao/c/4x2/page-'
    fine_jewellery = 'https://www.chanel.com/pt/joalharia/colecao/c/3x2/page-'
    face_url = 'https://www.chanel.com/pt/maquilhagem/tez/c/5x1x6/page-'
    eye_url = 'https://www.chanel.com/pt/maquilhagem/olhos/c/5x1x4/page-'
    lips_url = 'https://www.chanel.com/pt/maquilhagem/labios/c/5x1x1/page-'
    nails_url = 'https://www.chanel.com/pt/maquilhagem/unhas/c/5x1x7/page-'
    brushes_url = 'https://www.chanel.com/pt/maquilhagem/pinceis-e-acessorios/c/5x1x3/page-'
    skin_care = 'https://www.chanel.com/pt/tratamento/categoria/c/6x1/page-'
    skin_line_url = 'https://www.chanel.com/pt/tratamento/colecao/c/6x2/page-'
    frag_bb_url = 'https://www.chanel.com/pt/perfumes/banho-e-corpo/c/7x1x7/page-'
    ...
    def parse(self, response):  # Getting the links from selector and filtering the required urls
        for link in response.css('ul.header__category__links a::attr(href)'):
            a = link.get()
            if a == '/pt/oculos/oculos-de-sol/c/2x1x1/':
                page = self.site + '/pt/oculos/oculos-de-sol/c/2x1x1/'
                next_page = response.follow(url=page, callback=self.sunglass)
                yield next_page

            elif a == '/pt/oculos/oculos-graduados/c/2x1x2/':
                page1 = self.site + '/pt/oculos/oculos-graduados/c/2x1x2/'
                next_page1 = response.follow(url=page1, callback=self.eyeglass)
                yield next_page1

            elif a == '/pt/perfumes/mulheres/c/7x1x1/':
                page2 = self.site + '/pt/perfumes/mulheres/c/7x1x1/'
                yield response.follow(url=page2, callback=self.fragrance)

            elif a == '/pt/relogios/colecao/c/4x2/':
                page3 = self.site + '/pt/relogios/colecao/c/4x2/'
                yield response.follow(url=page3, callback=self.watches)

            elif a == '/pt/joalharia/colecao/c/3x2/':
                page4 = self.site + '/pt/joalharia/colecao/c/3x2/'
                yield response.follow(url=page4, callback=self.fine_jwlry)

            elif a == '/pt/maquilhagem/tez/c/5x1x6/':
                page5 = self.site + '/pt/maquilhagem/tez/c/5x1x6/'
                yield response.follow(url=page5, callback=self.mkp_face)

            elif a == '/pt/maquilhagem/olhos/c/5x1x4/':
                page6 = self.site + '/pt/maquilhagem/olhos/c/5x1x4/'
                yield response.follow(url=page6, callback=self.mkp_eye)

            elif a == '/pt/maquilhagem/labios/c/5x1x1/':
                page7 = self.site + '/pt/maquilhagem/labios/c/5x1x1/'
                yield response.follow(url=page7, callback=self.mkp_lips)

            elif a == '/pt/maquilhagem/unhas/c/5x1x7/':
                page8 = self.site + '/pt/maquilhagem/unhas/c/5x1x7/'
                yield response.follow(url=page8, callback=self.mkp_nails)

            elif a == '/pt/maquilhagem/pinceis-e-acessorios/c/5x1x3/':
                page9 = self.site + '/pt/maquilhagem/pinceis-e-acessorios/c/5x1x3/'
                yield response.follow(url=page9, callback=self.mkp_brushes)

            elif a == '/pt/moda/ready-to-wear/':
                page10 = self.site + '/pt/moda/ready-to-wear/'
                yield response.follow(page10, callback=self.parse_page)

            elif a == '/pt/tratamento/categoria/c/6x1/':
                page11 = self.site + '/pt/tratamento/categoria/c/6x1/'
                yield response.follow(page11, callback=self.skin)

            elif a == '/pt/tratamento/colecao/c/6x2/':
                page12 = self.site + '/pt/tratamento/colecao/c/6x2/'
                yield response.follow(page12, callback=self.skin_line)

            elif a == '/pt/perfumes/homens/c/7x1x2/':
                page13 = self.site + '/pt/perfumes/homens/c/7x1x2/'
                yield response.follow(url=page13, callback=self.frag_m)

            elif a == '/pt/perfumes/banho-e-corpo/c/7x1x7/':
                page14 = self.site + '/pt/perfumes/banho-e-corpo/c/7x1x7/'
