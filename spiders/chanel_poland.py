...
class ChanelPolandSpider(scrapy.Spider):   # Starting our spider with a class which contains url to initiate crawling
    name = 'chanel_poland'
    site = 'https://www.chanel.com'

    start_urls = ['https://www.chanel.com/pl/']
    frag_url = 'https://www.chanel.com/pl/zapachy/kobiety/c/7x1x1/page-'
    frag_m_url = 'https://www.chanel.com/pl/zapachy/mezczyzni/c/7x1x2/page-'
    eyegls_url = 'https://www.chanel.com/pl/okulary/okulary-korekcyjne/c/2x1x2/page-'
    sungls_url = 'https://www.chanel.com/pl/okulary/okulary-przeciwsoneczne/c/2x1x1/page-'
    watch_url = 'https://www.chanel.com/pl/zegarki/kolekcja/c/4x2/page-'
    fine_jewellery = 'https://www.chanel.com/pl/bizuteria/kolekcja/c/3x2/page-'
    face_url = 'https://www.chanel.com/pl/makijaz/cera/c/5x1x6/page-'
    eye_url = 'https://www.chanel.com/pl/makijaz/oczy/c/5x1x4/page-'
    lips_url = 'https://www.chanel.com/pl/makijaz/usta/c/5x1x1/page-'
    nails_url = 'https://www.chanel.com/pl/makijaz/paznokcie/c/5x1x7/page-'
    brushes_url = 'https://www.chanel.com/pl/makijaz/pedzle-i-akcesoria/c/5x1x3/page-'
    skin_care = 'https://www.chanel.com/pl/pielegnacja-skory/kategoria/c/6x1/page-'
    skin_line_url = 'https://www.chanel.com/pl/pielegnacja-skory/kolekcja/c/6x2/page-'
    frag_bb_url = 'https://www.chanel.com/pl/zapachy/do-kapieli-i-pielegnacji-ciaa/c/7x1x7/page-'
    ...
    def parse(self, response):  # Getting the links from selector and filtering the required urls
        for link in response.css('ul.header__category__links a::attr(href)'):
            a = link.get()
            if a == '/pl/okulary/okulary-przeciwsoneczne/c/2x1x1/':
                page = self.site + '/pl/okulary/okulary-przeciwsoneczne/c/2x1x1/'
                next_page = response.follow(url=page, callback=self.sunglass)
                yield next_page

            elif a == '/pl/okulary/okulary-korekcyjne/c/2x1x2/':
                page1 = self.site + '/pl/okulary/okulary-korekcyjne/c/2x1x2/'
                next_page1 = response.follow(url=page1, callback=self.eyeglass)
                yield next_page1

            elif a == '/pl/zapachy/kobiety/c/7x1x1/':
                page2 = self.site + '/pl/zapachy/kobiety/c/7x1x1/'
                yield response.follow(url=page2, callback=self.fragrance)

            elif a == '/pl/zegarki/kolekcja/c/4x2/':
                page3 = self.site + '/pl/zegarki/kolekcja/c/4x2/'
                yield response.follow(url=page3, callback=self.watches)

            elif a == '/pl/bizuteria/kolekcja/c/3x2/':
                page4 = self.site + '/pl/bizuteria/kolekcja/c/3x2/'
                yield response.follow(url=page4, callback=self.fine_jwlry)

            elif a == '/pl/makijaz/cera/c/5x1x6/':
                page5 = self.site + '/pl/makijaz/cera/c/5x1x6/'
                yield response.follow(url=page5, callback=self.mkp_face)

            elif a == '/pl/makijaz/oczy/c/5x1x4/':
                page6 = self.site + '/pl/makijaz/oczy/c/5x1x4/'
                yield response.follow(url=page6, callback=self.mkp_eye)

            elif a == '/pl/makijaz/usta/c/5x1x1/':
                page7 = self.site + '/pl/makijaz/usta/c/5x1x1/'
                yield response.follow(url=page7, callback=self.mkp_lips)

            elif a == '/pl/makijaz/paznokcie/c/5x1x7/':
                page8 = self.site + '/pl/makijaz/paznokcie/c/5x1x7/'
                yield response.follow(url=page8, callback=self.mkp_nails)

            elif a == '/pl/makijaz/pedzle-i-akcesoria/c/5x1x3/':
                page9 = self.site + '/pl/makijaz/pedzle-i-akcesoria/c/5x1x3/'
                yield response.follow(url=page9, callback=self.mkp_brushes)

            elif a == '/pl/moda/ready-to-wear/':
                page10 = self.site + '/pl/moda/ready-to-wear/'
                yield response.follow(page10, callback=self.parse_page)

            elif a == '/pl/pielegnacja-skory/kategoria/c/6x1/':
                page11 = self.site + '/pl/pielegnacja-skory/kategoria/c/6x1/'
                yield response.follow(page11, callback=self.skin)

            elif a == '/pl/pielegnacja-skory/kolekcja/c/6x2/':
                page12 = self.site + '/pl/pielegnacja-skory/kolekcja/c/6x2/'
                yield response.follow(page12, callback=self.skin_line)

            elif a == '/pl/zapachy/mezczyzni/c/7x1x2/':
                page13 = self.site + '/pl/zapachy/mezczyzni/c/7x1x2/'
                yield response.follow(url=page13, callback=self.frag_m)

            elif a == '/pl/zapachy/do-kapieli-i-pielegnacji-ciaa/c/7x1x7/':
                page14 = self.site + '/pl/zapachy/do-kapieli-i-pielegnacji-ciaa/c/7x1x7/'
